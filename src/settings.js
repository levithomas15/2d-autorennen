...
export const SCHEMA = [
  {
    ...
    items: [
      ...
      { key: 'uiScale', label: 'GROESSE DER BEDIENELEMENTE', type: 'range',
        min: 0.5, max: 1.4, step: 0.05, def: 1,
        help: 'Lenkrad, Pedale und Schalthebel kleiner oder groesser machen.' },
